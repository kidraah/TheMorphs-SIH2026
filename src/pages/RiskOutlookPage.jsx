    ...
    <div className="space-y-4">
      ...
      <div className="bg-white border border-slate-200 rounded p-3.5 flex flex-wrap items-center justify-between gap-3 shadow-gov-sm">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-[#0A3871] hover:bg-[#07264F] text-white text-xs font-semibold rounded flex items-center gap-1.5 shadow-sm transition-colors"
        >
      ...
      {/* Filter Bar */}
      <div className="bg-white border border-slate-200 rounded p-3 shadow-gov-sm flex flex-wrap items-center justify-between gap-3 text-xs">
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-1.5">
            <Filter className="w-3.5 h-3.5 text-slate-500" />
            <span className="font-bold text-slate-700">Filter By State:</span>
            <select
              value={filterState}
          ...
          <div className="flex items-center gap-1.5">
            <span className="font-bold text-slate-700">Risk Severity:</span>
            <select
              value={filterRisk}
      ...
      {/* District Data Table */}
      <div className="bg-white border border-slate-200 rounded shadow-gov-sm overflow-x-auto">
          ...
          <tbody className="divide-y divide-slate-200">
            {filteredDistricts.map((item) => (
              <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                <td className="p-2.5 font-bold text-[#0A3871]">{item.name}</td>
