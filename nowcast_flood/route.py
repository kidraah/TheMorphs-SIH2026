...
from .timing import peak_discharge, time_of_concentration
...
class FloodRouter:
    ...
    def from_layers(cls, direction, upa_km2, curve_number, hand_m=None,
        ...
        return cls(fg, bas, curve_number, hand_m, population, cell_area_km2,
                   cell_size_m, amc, channel, channel_km2)
    ...
    def route(self, rain_mm, rain_duration_min: float = 60.0,
        ...
        timing = time_of_concentration(self.basins.channel_length_m,
                                       self.basins.channel_slope,
                                       self.basins.area_km2,
