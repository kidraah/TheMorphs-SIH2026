...
export const LiveMapPage = () => {
  const { mapLayers, toggleMapLayer, selectedDistrict: globalSelectedDistrict, setSelectedDistrict, districtRiskData } = useAppStore();
  
  // Use global selected district or default to first from fetched data
  const selectedDistrict = globalSelectedDistrict || (districtRiskData && districtRiskData.length > 0 ? districtRiskData[0] : null);
          ...
          <div className="bg-white border border-[#E2E2E2] rounded p-3.5 shadow-gov-sm">
            ...
            <div className="mb-3">
              ...
              <select
                ...
                onChange={(e) => {
                  const dist = (districtRiskData || []).find((d) => d.id === e.target.value);
